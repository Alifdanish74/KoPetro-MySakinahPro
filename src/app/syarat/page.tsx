...
const syaratPenyertaan = [
  "Keahlian adalah terbuka kepada semua ahli Koperasi Hasil Dalam Negeri Malaysia Berhad / KotaMas dan kakitangan Lembaga Hasil Dalam Negeri (LHDN) yang berkhidmat di seluruh Malaysia (semua bangsa & agama).",
  ...
  "Untuk bukan ahli KotaMas: tambahan caj proses pentadbiran RM1 sebulan akan dikenakan pada pemotong gaji utama. Contoh: En Ali mendaftar pakej keluarga 20 sebulan dan pakej Individu 10 untuk Ibu. Jumlah potongan gaji adalah RM20 + RM10 + RM1 = RM31 sebulan.",
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-600">
                  Panduan kelayakan dan pendaftaran ahli KotaMas & LHDN
                </p>
              </div>
            </div>
